...
public class HandAnimator : MonoBehaviour
{
    ...
    private void ActivateUIHandPose(UIHoverEventArgs args)
    {
    ...
    private void DeactivateUIHandPose(UIHoverEventArgs args)
    {
