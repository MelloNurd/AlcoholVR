...
namespace EditorAttributes
{
	...
	public class ShowFieldAttribute : PropertyAttribute, IConditionalAttribute
    {
        ...
        public ShowFieldAttribute(string conditionName, bool applyToCollection = false)
		...
		public ShowFieldAttribute(string conditionName, object enumValue, bool applyToCollection = false) 
#if UNITY_2023_3_OR_NEWER
        : base(applyToCollection) 
#endif
        {
